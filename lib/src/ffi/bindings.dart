...
class LibEdaxBindings {
  ...
  late final ffi.Pointer<ffi.Int64> _timezone_1 = _lookup<ffi.Int64>('timezone');

  int get timezone_1 => _timezone_1.value;

  set timezone_1(int value) => _timezone_1.value = value;
