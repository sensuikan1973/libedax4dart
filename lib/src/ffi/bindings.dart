...
late final _libedax_terminatePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function()>>('libedax_terminate');
...
late final ffi.Pointer<ffi.Pointer<Selectivity>> _selectivity_table = _lookup<ffi.Pointer<Selectivity>>('selectivity_table');
...
late final ffi.Pointer<ffi.Pointer<ffi.Char>> _sys_siglist = _lookup<ffi.Pointer<ffi.Char>>('sys_siglist');

ffi.Pointer<ffi.Pointer<ffi.Char>> get sys_siglist => _sys_siglist;

late final ffi.Pointer<ffi.Pointer<ffi.Char>> _sys_signame = _lookup<ffi.Pointer<ffi.Char>>('sys_signame');
...
late final ffi.Pointer<ffi.Pointer<ffi.NativeFunction<ffi.LongLong Function()>>> _time_clock = _lookup<ffi.Pointer<ffi.NativeFunction<ffi.LongLong Function()>>>('time_clock');

ffi.Pointer<ffi.NativeFunction<ffi.LongLong Function()>> get time_clock => _time_clock.value;
...
final class BoardCache extends ffi.Struct{
 ...
 static ffi.Pointer<BoardCache> $allocate(
 ffi.Allocator $allocator, {
 required ffi.Pointer<Board> array,
 required int size,
 required int mask,
 }) => $allocator<BoardCache>()
 ..ref.array = array
 ..ref.size = size
 ..ref.mask = mask;
...
final class Book extends ffi.Struct{
  external UnnamedStruct$3 date;

  external UnnamedStruct$4 options$1;

  external UnnamedStruct$5 stats;
...
set count_bestpath_stop(Stop value) => count_bestpath_stopAsInt = value.value;
...
final class Bound extends ffi.Struct{
 ...
 static ffi.Pointer<Bound> $allocate(
 ffi.Allocator $allocator, {
 required int lower,
 required int upper,
 }) => $allocator<Bound>()
...
@ffi.Array.multi([16])
  external ffi.Array<UnnamedStruct$1> feature;
...
@ffi.Array.multi([1])
  ...
  external UnnamedStruct$6 last_position;
...
@ffi.Array.multi([1])
  ...
  /// < loop instruction
@ffi.Array.multi([1])
  external ffi.Array<UnnamedStruct$7> loop;

  /// < command issued once after some delay
@ffi.Array.multi([1])
  external ffi.Array<UnnamedStruct$8> once;
...
final class GGSClock extends ffi.Struct{
 ...
 static ffi.Pointer<GGSClock> $allocate(
 ffi.Allocator $allocator, {
 required int ini_flag,
 required int inc_flag,
 required int ext_flag,
 required int ini_move,
 required int inc_move,
 required int ext_move,
 required int ini_time,
 required int inc_time,
 required int ext_time,
 }) => $allocator<GGSClock>()
 ..ref.ini_flag = ini_flag
 ..ref.inc_flag = inc_flag
 ..ref.ext_flag = ext_flag
 ..ref.ini_move = ini_move
 ..ref.inc_move = inc_move
 ..ref.ext_move = ext_move
 ..ref.ini_time = ini_time
 ..ref.inc_time = inc_time
 ..ref.ext_time = ext_time;
...
final class GGSMatchType extends ffi.Struct{
 ...
 static ffi.Pointer<GGSMatchType> $allocate(
 ffi.Allocator $allocator, {
 required int is_saved,
 required int is_rated,
 required int is_synchro,
 required int is_komi,
 required int is_rand,
 required int is_anti,
 required int discs,
 required int size,
 }) => $allocator<GGSMatchType>()
 ..ref.is_saved = is_saved
 ..ref.is_rated = is_rated
 ..ref.is_synchro = is_synchro
 ..ref.is_komi = is_komi
 ..ref.is_rand = is_rand
 ..ref.is_anti = is_anti
 ..ref.discs = discs
...
final class GameStatistics extends ffi.Struct{
 ...
 static ffi.Pointer<GameStatistics> $allocate(
 ffi.Allocator $allocator, {
 required int n_moves,
 required int n_draws,
 required int n_losses,
 required int n_wins,
 required int n_passes,
 required int min_mobility,
 required int max_mobility,
 }) => $allocator<GameStatistics>()
 ..ref.n_moves = n_moves
 ..ref.n_draws = n_draws
 ..ref.n_losses = n_losses
 ..ref.n_wins = n_wins
 ..ref.n_passes = n_passes
 ..ref.min_mobility = min_mobility
 ..ref.max_mobility = max_mobility;
...
final class GameStats extends ffi.Struct{
 ...
 static ffi.Pointer<GameStats> $allocate(
 ffi.Allocator $allocator, {
 required int n_wins,
 required int n_draws,
 required int n_losses,
...
final class Move extends ffi.Struct{
 ...
 static ffi.Pointer<Move> $allocate(
 ffi.Allocator $allocator, {
 required int flipped,
 required int x,
 required int score,
 required int cost,
 required ffi.Pointer<Move> next,
 }) => $allocator<Move>()
 ..ref.flipped = flipped
 ..ref.x = x
 ..ref.score = score
...
final class MoveArray extends ffi.Struct{
 ...
 static ffi.Pointer<MoveArray> $allocate(
 ffi.Allocator $allocator, {
 required ffi.Pointer<MBoard> item,
 required int n,
 required int size,
 }) => $allocator<MoveArray>()
 ..ref.item = item
...
@ffi.Array.multi([1])
  ...
  /// <! Move array
@ffi.Array.multi([32])
  external ffi.Array<UnnamedStruct$9> move;
...
set play_type(PlayType value) => play_typeAsInt = value.value;
...
final class PositionArray extends ffi.Struct{
 ...
 static ffi.Pointer<PositionArray> $allocate(
 ffi.Allocator $allocator, {
 required ffi.Pointer<Position> positions,
 required int n,
 required int size,
 }) => $allocator<PositionArray>()
...
final class PositionHash extends ffi.Struct{
 ...
 static ffi.Pointer<PositionHash> $allocate(
 ffi.Allocator $allocator, {
 required ffi.Pointer<PosArray> array,
 required int size,
 required int mask,
 }) => $allocator<PositionHash>()
 ..ref.array = array
 ..ref.size = size
 ..ref.mask = mask;
...
final class Selectivity extends ffi.Struct{
 ...
 static ffi.Pointer<Selectivity> $allocate(
 ffi.Allocator $allocator, {
 required double t,
 required int level,
 required int percent,
 }) => $allocator<Selectivity>()
 ..ref.t = t
 ..ref.level = level
 ..ref.percent = percent;
...
final class SquareList extends ffi.Struct{
 ...
 static ffi.Pointer<SquareList> $allocate(
 ffi.Allocator $allocator, {
 required int b,
 required int x,
 required int quadrant,
 required ffi.Pointer<SquareList> previous,
 required ffi.Pointer<SquareList> next,
 }) => $allocator<SquareList>()
 ..ref.b = b
 ..ref.x = x
 ..ref.quadrant = quadrant
...
final class TaskStack extends ffi.Struct{
 ...
 static ffi.Pointer<TaskStack> $allocate(
 ffi.Allocator $allocator, {
 required int spin,
 required ffi.Pointer<Task> task,
 required ffi.Pointer<ffi.Pointer<Task>> stack,
 required int n,
 required int n_idle,
 }) => $allocator<TaskStack>()
 ..ref.spin = spin
...
final class UnnamedStruct$4 extends ffi.Struct{
 ...
 ffi.Allocator $allocator, {
 required int level,
 required int n_empties,
 required int midgame_error,
 required int endcut_error,
 required int verbosity,
 }) => $allocator<UnnamedStruct$4>()
 ..ref.level = level
 ..ref.n_empties = n_empties
 ..ref.midgame_error = midgame_error
 ..ref.endcut_error = endcut_error
...
final class WthorHeader extends ffi.Struct{
 ...
 static ffi.Pointer<WthorHeader> $allocate(
 ffi.Allocator $allocator, {
 required int century,
 required int year,
 required int month,
 required int day,
 required int board_size,
 required int game_type,
 required int depth,
 required int reserved,
 required int n,
 required int game_year,
 required int n_games,
 }) => $allocator<WthorHeader>()
 ..ref.century = century
 ..ref.year = year
 ..ref.month = month
 ..ref.day = day
 ..ref.board_size = board_size
 ..ref.game_type = game_type
 ..ref.depth = depth
 ..ref.reserved = reserved
 ..ref.n = n
 ..ref.game_year = game_year
 ..ref.n_games = n_games;
...
@ffi.Array.multi([32])
  ...
  external ffi.Pointer<ffi.NativeFunction<__darwin_rune_t Function(ffi.Pointer<ffi.Char> , __darwin_size_t , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> __sgetrune;

  external ffi.Pointer<ffi.NativeFunction<ffi.Int Function(__darwin_rune_t , ffi.Pointer<ffi.Char> , __darwin_size_t , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> __sputrune;
...
final class addrinfo extends ffi.Struct{
 ...
 static ffi.Pointer<addrinfo> $allocate(
 ffi.Allocator $allocator, {
 required int ai_flags,
 required int ai_family,
 required int ai_socktype,
 required int ai_protocol,
 required int ai_addrlen,
 required ffi.Pointer<ffi.Char> ai_canonname,
 required ffi.Pointer<sockaddr> ai_addr,
 required ffi.Pointer<addrinfo> ai_next,
 }) => $allocator<addrinfo>()
 ..ref.ai_flags = ai_flags
 ..ref.ai_family = ai_family
 ..ref.ai_socktype = ai_socktype
 ..ref.ai_protocol = ai_protocol
 ..ref.ai_addrlen = ai_addrlen
 ..ref.ai_canonname = ai_canonname
 ..ref.ai_addr = ai_addr
 ..ref.ai_next = ai_next;
...
final class cmsghdr extends ffi.Struct{
 ...
 static ffi.Pointer<cmsghdr> $allocate(
 ffi.Allocator $allocator, {
 required int cmsg_len,
 required int cmsg_level,
 required int cmsg_type,
 }) => $allocator<cmsghdr>()
 ..ref.cmsg_len = cmsg_len
 ..ref.cmsg_level = cmsg_level
 ..ref.cmsg_type = cmsg_type;
...
final class in_addr extends ffi.Struct{
 ...
 static ffi.Pointer<in_addr> $allocate(
 ffi.Allocator $allocator, {
 required int s_addr,
 }) => $allocator<in_addr>()
 ..ref.s_addr = s_addr;
...
final class lconv extends ffi.Struct{
 ...
 static ffi.Pointer<lconv> $allocate(
 ffi.Allocator $allocator, {
 required ffi.Pointer<ffi.Char> decimal_point,
 required ffi.Pointer<ffi.Char> thousands_sep,
 required ffi.Pointer<ffi.Char> grouping,
 required ffi.Pointer<ffi.Char> int_curr_symbol,
 required ffi.Pointer<ffi.Char> currency_symbol,
 required ffi.Pointer<ffi.Char> mon_decimal_point,
 required ffi.Pointer<ffi.Char> mon_thousands_sep,
 required ffi.Pointer<ffi.Char> mon_grouping,
 required ffi.Pointer<ffi.Char> positive_sign,
 required ffi.Pointer<ffi.Char> negative_sign,
 required int int_frac_digits,
 required int frac_digits,
 required int p_cs_precedes,
 required int p_sep_by_space,
 required int n_cs_precedes,
 required int n_sep_by_space,
 required int p_sign_posn,
 required int n_sign_posn,
 required int int_p_cs_precedes,
 required int int_n_cs_precedes,
 required int int_p_sep_by_space,
 required int int_n_sep_by_space,
 required int int_p_sign_posn,
 required int int_n_sign_posn,
 }) => $allocator<lconv>()
 ..ref.decimal_point = decimal_point
 ..ref.thousands_sep = thousands_sep
 ..ref.grouping = grouping
 ..ref.int_curr_symbol = int_curr_symbol
 ..ref.currency_symbol = currency_symbol
 ..ref.mon_decimal_point = mon_decimal_point
 ..ref.mon_thousands_sep = mon_thousands_sep
 ..ref.mon_grouping = mon_grouping
 ..ref.positive_sign = positive_sign
 ..ref.negative_sign = negative_sign
 ..ref.int_frac_digits = int_frac_digits
 ..ref.frac_digits = frac_digits
 ..ref.p_cs_precedes = p_cs_precedes
 ..ref.p_sep_by_space = p_sep_by_space
 ..ref.n_cs_precedes = n_cs_precedes
 ..ref.n_sep_by_space = n_sep_by_space
 ..ref.p_sign_posn = p_sign_posn
 ..ref.n_sign_posn = n_sign_posn
 ..ref.int_p_cs_precedes = int_p_cs_precedes
 ..ref.int_n_cs_precedes = int_n_cs_precedes
 ..ref.int_p_sep_by_space = int_p_sep_by_space
 ..ref.int_n_sep_by_space = int_n_sep_by_space
 ..ref.int_p_sign_posn = int_p_sign_posn
 ..ref.int_n_sign_posn = int_n_sign_posn;
...
final class sa_endpoints extends ffi.Struct{
 ...
 static ffi.Pointer<sa_endpoints> $allocate(
 ffi.Allocator $allocator, {
 required int sae_srcif,
 required ffi.Pointer<sockaddr> sae_srcaddr,
 required int sae_srcaddrlen,
 required ffi.Pointer<sockaddr> sae_dstaddr,
 required int sae_dstaddrlen,
 }) => $allocator<sa_endpoints>()
 ..ref.sae_srcif = sae_srcif
 ..ref.sae_srcaddr = sae_srcaddr
 ..ref.sae_srcaddrlen = sae_srcaddrlen
 ..ref.sae_dstaddr = sae_dstaddr
 ..ref.sae_dstaddrlen = sae_dstaddrlen;
...
final class sf_hdtr extends ffi.Struct{
 ...
 static ffi.Pointer<sf_hdtr> $allocate(
 ffi.Allocator $allocator, {
 required ffi.Pointer<iovec> headers,
 required int hdr_cnt,
 required ffi.Pointer<iovec> trailers,
 required int trl_cnt,
 }) => $allocator<sf_hdtr>()
 ..ref.headers = headers
 ..ref.hdr_cnt = hdr_cnt
...
final class so_np_extensions extends ffi.Struct{
 ...
 static ffi.Pointer<so_np_extensions> $allocate(
 ffi.Allocator $allocator, {
 required int npx_flags,
 required int npx_mask,
 }) => $allocator<so_np_extensions>()
 ..ref.npx_flags = npx_flags
 ..ref.npx_mask = npx_mask;
...
typedef tcp_cc = __uint32_t;
final class tcp_connection_info extends ffi.Opaque{
}

typedef tcp_seq = __uint32_t;
...
final class timeval64 extends ffi.Struct{
 ...
 static ffi.Pointer<timeval64> $allocate(
 ffi.Allocator $allocator, {
 required int tv_sec,
 required int tv_usec,
 }) => $allocator<timeval64>()
...
final class timezone$1 extends ffi.Struct{
 ...
 static ffi.Pointer<timezone$1> $allocate(
 ffi.Allocator $allocator, {
 required int tz_minuteswest,
 required int tz_dsttime,
 }) => $allocator<timezone$1>()
 ..ref.tz_minuteswest = tz_minuteswest
 ..ref.tz_dsttime = tz_dsttime;
