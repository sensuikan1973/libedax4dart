...
class _LibEdaxBindings {
  ...
  late final int Function(Pointer<Uint8> board) edaxSetboard;
  late final int Function() edaxVmirror;
  late final int Function(Pointer<Uint8> moves) edaxPlay;
  late final int Function() edaxGo;
  late final int Function() edaxStop;
  late final int Function() edaxVersion;
  late final int Function(Pointer<Uint8> moves) edaxMove;
  ...
  late final int Function(Pointer<Uint8> optionName, Pointer<Uint8> val) edaxSetOption;
  late final Pointer<Uint8> Function(Pointer<Uint8> str) edaxGetMoves;
