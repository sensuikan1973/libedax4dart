...
class LibEdax {
  ...
  /// Compute the indicator to win efficiently, which means the minimum number you should memorize on the situation both of players always choose his/her best move.
  ///
  /// This is a Dart level function, and unique feature to libedax4dart.
  ///
  /// You can see the graph of tree generated by this function, with using [BestPathNumWithLink.exportGraphvizDotFile()]. <br>
  /// e.g. On light book, If current moves is 'f5f6', you can get a graph like this([graphviz online](https://bit.ly/3edxWGO)).
  ///
